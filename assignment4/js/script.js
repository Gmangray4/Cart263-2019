...
const patSFX = new Audio("assets/sounds/noThisIsP.wav");
const huhSFX = new Audio("assets/sounds/huh.wav");
...
function setup() {
  ...
  $patrick.draggable({ revert: "valid"});
...
if (event.toElement === document.getElementById('patrick')) {
//  console.log('doot');
patSFX.play();
}
